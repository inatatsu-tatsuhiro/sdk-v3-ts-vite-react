...
declare const sdk: {
    NetworkLocator: {
        findByName: (networks: array<import("./Network.js").Network>, singleOrMultipleNames: any) => import("./Network.js").Network;
        findByIdentifier: (networks: array<import("./Network.js").Network>, singleOrMultipleIdentifiers: any) => import("./Network.js").Network;
    };
    facade: {
    ...
    symbol: {
        ...
        proveMerkle: (leafHash: CryptoTypes.Hash256, merklePath: array<any>, rootHash: CryptoTypes.Hash256) => boolean;
        deserializePatriciaTreeNodes: (buffer: any) => ({
            value: CryptoTypes.Hash256;
            calculateHash(): CryptoTypes.Hash256;
            path: PatriciaTreePath;
            readonly hexPath: str;
        } | {
            links: array<CryptoTypes.Hash256>;
            calculateHash(): CryptoTypes.Hash256;
            path: PatriciaTreePath;
            readonly hexPath: str;
        })[];
        PatriciaMerkleProofResult: typeof SymbolMerkle.PatriciaMerkleProofResult;
        provePatriciaMerkle: (encodedKey: CryptoTypes.Hash256, valueToTest: CryptoTypes.Hash256, merklePath: array<{
            value: CryptoTypes.Hash256;
            calculateHash(): CryptoTypes.Hash256;
            path: PatriciaTreePath;
            readonly hexPath: str;
            ...
            path: PatriciaTreePath;
            readonly hexPath: str;
        }>, stateHash: CryptoTypes.Hash256, subcacheMerkleRoots: CryptoTypes.Hash256) => numeric;
